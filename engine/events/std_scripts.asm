...
InitializeEventsScript:
	...
	variablesprite SPRITE_RADIOTOWER_GIOVANNI, SPRITE_GIOVANNI_DISGUISE
	variablesprite SPRITE_TRAINER_HOUSE_PKMN_TRAINER, SPRITE_CHRIS
	setevent EVENT_GIOVANNI_RADIOTOWER
...
.NineBadgeCap:
	loadmem wLevelCap, 75 ; update level cap for hard mode
...
.TwelveBadgeCap:
	...
	sjump .LevelCapScriptEnd
.ThirteenBadgeCap:
	loadmem wLevelCap, 86 ; update level cap for hard mode
	sjump .LevelCapScriptEnd
.FourteenBadgeCap:
	loadmem wLevelCap, 89 ; update level cap for hard mode
	sjump .LevelCapScriptEnd
.FifteenBadgeCap:
	loadmem wLevelCap, 91 ; update level cap for hard mode
	sjump .LevelCapScriptEnd
.SixteenBadgeCap:
	loadmem wLevelCap, 91 ; update level cap for hard mode
	sjump .LevelCapScriptEnd
