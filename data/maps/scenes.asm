...
MapScenes::
	...
	scene_var LAVENDER_TOWN,                       		   wLavenderTownLoreleiSceneID
	scene_var PALLET_TOWN,                         		   wPalletTownAgathaSceneID
	scene_var SILVER_CAVE_ROOM_2,                          wSilverCaveGiovanniSceneID
