...
VermilionCity_MapEvents:
	...
	bg_event 35,  9, BGEVENT_READ, VermilionCityDiglettsCaveSign
	...
	bg_event  4, 19, BGEVENT_ITEM, VermilionCityHiddenFullHeal
	...
	object_event 26,  7, SPRITE_MACHOP, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, VermilionMachop, -1
