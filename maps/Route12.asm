...
Route12_MapEvents:
	...
	bg_event  9, 33, BGEVENT_READ, FishingSpotSign
	...
	object_event 13, 28, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 2, TrainerFisherStephen, -1
