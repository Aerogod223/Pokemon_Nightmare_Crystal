...
; OverworldSprites indexes (see data/sprites/sprites.asm)
	...
	const SPRITE_GIOVANNI ; 66
	const SPRITE_GIOVANNI_DISGUISE ; 67
	const SPRITE_ARCHER ; 68
...
SPRITE_POKEMON EQU const_value
	...
	const SPRITE_MEOWTH ; a5
	const SPRITE_NIDORAN_F ; a7
	const SPRITE_FARFETCH_D ; ab
	const SPRITE_BLISSEY ; ac
	const SPRITE_DODRIO ; ad
	const SPRITE_ABRA ; af
	const SPRITE_PSYDUCK ; b0
	const SPRITE_NIDORINO ; b1
	const SPRITE_PIDGEY ; b2
	const SPRITE_PERSIAN ; b3
	const SPRITE_NIDORAN_M ; b4
	const SPRITE_BAYLEEF ; b5
	const SPRITE_FEAROW ; b6
	const SPRITE_MILTANK ; b8
	const SPRITE_MEWTWO ; b9
	const SPRITE_ELECTRODE ; ba
	const SPRITE_MURKROW ; bb
	const SPRITE_SPEAROW ; bc
	const SPRITE_RATTATA ; bd
	const SPRITE_DRAGONITE
	const SPRITE_NIDOQUEEN
	const SPRITE_AMPHAROS
	const SPRITE_SENTRET
	const SPRITE_MEW
...
SPRITE_VARS EQU const_value
	...
	const SPRITE_RADIOTOWER_GIOVANNI
	const SPRITE_TRAINER_HOUSE_PKMN_TRAINER
