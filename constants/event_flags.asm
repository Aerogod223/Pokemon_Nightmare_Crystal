...
; Johto story events
	...
	const EVENT_CAUGHT_ALL_UNOWN ; const_skip ; unused
	...
	const EVENT_PASSED_GATE_GUARD_VICTORY_ROAD
...
; Unused: next 48 events
	...
	const EVENT_GOT_GOLD_BERRY_FROM_FLOWER_SHOP
	const EVENT_GOT_OLD_AMBER
	const EVENT_GOT_DOME_FOSSIL
	const EVENT_GOT_HELIX_FOSSIL
	const EVENT_GIOVANNI_RADIOTOWER
	const EVENT_MOUNT_MORTAR_B1F_CURSE
	const EVENT_CAUGHT_MOLTRES
	const EVENT_CAUGHT_ARTICUNO
	const EVENT_CAUGHT_ZAPDOS
	const EVENT_ELITE_4_REMATCH
	const EVENT_BEAT_LANCE_FIRST_TIME
