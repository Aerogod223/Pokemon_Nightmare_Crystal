...
GiovanniDisguiseSpriteGFX::    INCBIN "gfx/sprites/giovanni_disguise.2bpp"
ArcherSpriteGFX::              INCBIN "gfx/sprites/archer.2bpp"
MoltresOverworldSpriteGFX::    INCBIN "gfx/sprites/moltres.2bpp"
ArticunoOverworldSpriteGFX::   INCBIN "gfx/sprites/articuno.2bpp"
ZapdosOverworldSpriteGFX::     INCBIN "gfx/sprites/zapdos.2bpp"
ChrisRunSpriteGFX::            INCBIN "gfx/sprites/chris_run.2bpp"
KrisRunSpriteGFX::             INCBIN "gfx/sprites/kris_run.2bpp"
RattataOverworldSpriteGFX::    INCBIN "gfx/sprites/rattata_overworld.2bpp"
